from tkinter import Tk, Button, Listbox, PhotoImage, Frame, Menu, filedialog, END, ACTIVE, ANCHOR, Label, GROOVE, E, BOTTOM, X
import pygame
import time
...
# !
# * ADDED Song duration
# * CHANGED the WINDOW_HEIGHT from 325 to 350
