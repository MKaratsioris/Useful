...
class Bandoneon:
    def __init__(self, session: Session) -> None:
        ...
        self.bandoneon = self.session.new_part(self.name)
        self.range = RANGES["Bandoneon"]
        self.note: str = ""
